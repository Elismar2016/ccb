                            ...
                            <div class="caption">
                                ...
                                <div class="span3" style="width: 280px">
                                    <section id="modal">
                                        ...
                                        <section id="modalFree" class="modal" tabindex="-1" role="dialog" aria-labelledby="free" aria-hidden="true">
                                                    ...
                                                    <div class="thumbnail">
                                                        ...
                                                        <div class="caption">
                                                            ...
                                                            <p align="justify">
                                                                ...
                                                                <h5>Perceba que ao fim de cada visitante listado, temos um ícone de lápis <img title="Editar" src="<?= base_url('assets/img/icon/edit.png'); ?>" class="img-responsive" height="13" width="13">. Ele serve como atalho para a página de edição
                                                                    de visitante. Ao concluir a atualização no cadastro, retorna para a página de empréstimo da forma como estava.</h5>
                                ...
                                <div class="span3" style="width: 280px">
                                    <section id="modal">
                                        ...
                                        <section id="modalDisabled" class="modal hide" tabindex="-1" role="dialog" aria-labelledby="free" aria-hidden="true">
                                            <header class="modal-header">
                                                <a type="button" class="close" href="<?= base_url('help/init/2');?>">&times;</a>
